...
Object.defineProperties(Repository.prototype, {
    ...
    db: {enumerable: true, configurable: false, get: function () {
        return ignitor.db;
    }},
...
Repository.prototype.all = function (options, callback) {
    options = options || {};
    return this.db.api.simple.list(this.collection, options, callback);
};

Repository.prototype.findById = function (id, callback) {
    return this.db.api.simple.firstByExample(this.collection, {_id: id}, callback);
};
...
Repository.prototype.find = function (predicate, options, callback) {
    options = options || {};
    return this.db.api.simple.example(this.collection, predicate, options, callback);
};
...
Repository.prototype.query = function (query, params, options, callback) {
    params = params || {};
    options = options || {};
    return this.db.api.query(query, params, options, callback);
};
...
Repository.prototype.exists = function (predicate, options, callback) {
    options = options || {};
    return this.db.api.simple.firstByExample(this.collection, predicate, options, callback);
};
...
Repository.prototype.save = function (entity, options, callback) {
    ...
    if (entity._id) {
        ...
        return this.db.api.document.put(entity._id, entity).then(function (entity) {
            return self.db.api.document.get(entity._id, callback);
        });
    }
    else {
        return this.db.api.document.create(this.collection, entity, options).then(function (entity) {
            return self.db.api.document.get(entity._id, callback);
        });
    }
};
 ...
 * @param options
 * @param callback
 * @returns {*|Q.Promise<U>|ng.IHttpPromise<*>}
 */
Repository.prototype.remove = function (id, options, callback) {
    return this.db.api.document.delete(id, options, callback);
};
...
Repository.prototype.removeAll = function (predicate, options, callback) {
    return this.db.api.simple.removeByExample(this.collection, predicate, options, callback);
}
