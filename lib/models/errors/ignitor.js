...
function colorize(str, color) {
    var options = {
        red: '\u001b[31m', green: '\u001b[32m', yellow: '\u001b[33m', blue: '\u001b[34m', magenta: '\u001b[35m', cyan: '\u001b[36m', gray: '\u001b[90m', reset: '\u001b[0m'
    };
...
function IgnitorError(msg) {
    ...
    for (var i = 0; i < this.__stack.length; i++) {
        ...
        this._stack.push({
            filename: frame.getFileName(), typename: frame.getTypeName(), linenum: frame.getLineNumber(), funcname: frame.getFunctionName(), method: frame.getMethodName()
        });
    }
...
IgnitorError.prototype.toJSON = function () {
    return {
        name: this.name, message: this.message, memory: this.memory, stack: this._stack
    };
}